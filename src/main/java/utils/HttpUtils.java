...
//        }
    ...
    @SuppressWarnings({"unchecked", "rawtypes"})
    private static String xingshengInvokeUrl(String url, Map params, Map<String, String> headers, int connectTimeout, int readTimeout, String encoding, HttpMethod method) {
        //构造请求参数字符串
        //StringBuilder paramsStr = null;
//        if (params != null) {
//            paramsStr = new StringBuilder();
...
//        }
        ...
        try {
            ...
            if (params != null && method == HttpMethod.POST) {
                ...
                out = new BufferedWriter(new OutputStreamWriter(conn.getOutputStream(), encoding));
                String str = null;
                if(params.get("spuSns")!="" && params.get("spuSns")!=null){
                    str = "marketingDataQueryReq={\"spuSns\":%s,\"areaId\":102}";
                    str = String.format(str, params.get("spuSns").toString());

                }else{
                    str = "{\n" +
                            "\t\"windowId\": %s,\n" +
                            "\t\"areaId\": 102,\n" +
                            "\t\"storeId\": \"66880000053320\",\n" +
                            "\t\"excludeAct\": \"N\",\n" +
                            "\t\"windowType\": \"CLASSIFY\",\n" +
                            "\t\"pageSize\": 30,\n" +
                            "\t\"isFirstRefresh\": \"TRUE\"\n" +
                    ...
                    str = String.format(str, params.get("windowId"));
                }
                out.write(str);
                out.flush();
            }
    ...
    public static String xingshengPost(String url, Map params, Map<String, String> headers, int connectTimeout, int readTimeout, String charset) {
        return xingshengInvokeUrl(url, params, headers, connectTimeout, readTimeout, charset, HttpMethod.POST);
    }
